 ...
 * @author jake
 */
public class TeachDaoDB implements TeacherDao{
    ...
    @Override
    @Transactional // needs to be Transactional because of the lastInsertID() function
    ...
    @Override
    @Transactional // using this b/c there's multiple queries altering the DB
